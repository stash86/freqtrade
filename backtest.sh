...
#freqtrade lookahead-analysis --config user_data/other_configs/config-static-btc-futures-wildcard.json --strategy-path ../freqtrade_strategies/ --timerange=20220201-20230201 --strategy Rsiqui --fee 0.001 --targeted-trade-amount 10 --timeframe 15m

freqtrade recursive-analysis --config user_data/other_configs/config-static-btc-futures-wildcard.json --strategy-path ../freqtrade_strategies/ --timerange=20220301-20250501 --strategy Rsiqui
